...
Máy chủ dùng thuật toán nhưFederated Averagingđể hợp nhất các trọng số, tạo ra mô hình toàn cục mới.
...
# Kiến trúc và thành phần chính
  ...
  * Aggregation Algorithm: Thuật toán nhưFedAvg,FedProxđể cân bằng chênh lệch dữ liệu giữa các khách.
