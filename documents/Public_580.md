...
<tbody>
<tr>
<td rowspan="2"><strong>Loại tài sản cố định</strong></td>
<td colspan="2"><strong>Đầu năm</strong></td>
<td colspan="2"><strong>Cuối năm</strong></td>
<td colspan="2"><strong>Chênh lệch</strong></td>
</tr>
<tr>
<td><strong>N.giá</strong></td>
<td><strong>%</strong></td>
<td><strong>N.giá</strong></td>
<td><strong>%</strong></td>
...
<tr>
<td><p>1.Tsản CĐ dùng trong s.xuất</p>
<p>-Trong đó phương tiện kthuật</p>
<p>2.Tsản cố định dùng ngoài s.x</p>
<p>- Tsản c.đ dùng cho b.hàng</p>
<p>- Tài sản cố định cho qủan lý</p></td>
<td><p>750</p>
<p>350</p>
<p>500</p>
<p>150</p>
...
H:Hệ số hao mòn tài sản cố định_

HM:Giá trị hao mòn luỹ kế_
...
<tr>
<td rowspan="2"><strong>Loại tài sản cố định</strong></td>
<td colspan="2"><strong>NG (1.000đồng)</strong></td>
<td colspan="2"><strong>H.mòn (1.000đồng)</strong></td>
<td colspan="2"><strong>HSH.mòn ( %)</strong></td>
</tr>
<tr>
<td><strong>Đ.N</strong></td>
...
<tr>
<td><p>1.TSCĐ dùng trong s.x</p>
<p>-Phương tiện k.thuật</p>
<p>-Nhà cửa, vật kiến trúc</p>
<p>2.TSCĐ dùng ngoài s.x</p>
<p>-TSCĐ bán hàng</p>
<p>-TSCĐ qủan lý</p></td>
<td><p>750.000</p>
<p>400.000</p>
...
<td><strong>1.327.000</strong></td>
<td><strong>375.000</strong></td>
<td><strong>504.260</strong></td>
...
_\- Phương pháp phân tích: H s = Hs1 \- Hs0_

Nếu Hs > 0: hiệu suất sử dụng tài sản cố định tốt hơn

Nếu Hs < 0: hiệu suất sử dụng tài sản cố định kém hơn

Nếu Hs = 0: hiệu suất sử dụng tài sản cố không thay đổi
...
_Đối tượng phân tích: G s = Gs1 \- Gs0_

Có 2 nhân tố ảnh hưởng đến giá trị sản xuất là: nguyên giá TSCĐ bình quân và hiệu suất sử dụng TSCĐ

* Nguyên giá TSCĐ ảnh hưởng đến Gs: $\mathrm{\Delta}{Gs}_{(Ng)} = \left( {Ng}_{1} - {Ng}_{0} \right)*{Hs}_{0}$

* Hiệu suất sử dụng TSCĐ ảnh hưởng đến Gs$:\mathrm{\Delta}{Gs}_{\left( H_{s} \right)} = \left( H_{s1} - H_{s0} \right)*{Ng}_{1}$

_\- Tổng hợp các nhân tố ảnh hưởng:$\ \mathrm{\Delta}Gs = \mathrm{\Delta}{Gs}_{(Ng)} + \ \mathrm{\Delta}{Gs}_{\left( H_{s} \right)}$
...
<tbody>
<tr>
<td rowspan="2"><strong>Chỉ tiêu</strong></td>
<td rowspan="2"><strong>Năm trước</strong></td>
<td rowspan="2"><strong>Năm nay</strong></td>
<td colspan="2"><strong>Chênh lệch</strong></td>
</tr>
<tr>
<td><strong>Mức</strong></td>
...
<tr>
<td><p>1.Gía trị sản xuất</p>
<p>2.Nguyên giá TSCĐ bình quân</p>
<p>3.Hiệu suất s.dụng TSCĐ</p></td>
<td><p>68.460</p>
<p>1.050</p>
<p>65,2</p></td>
<td><p>77.292</p>
...
_Bước 1: Chỉ tiêu phân tích:Gs0=68.460 Gs1=77.292

_Bước 2: Đối tượng phân tíchGs = 8.832

_Bước 3: Mức độ ảnh hưởng của nhân tố đến giá trị sản xuất_

Nguyên giá TSCĐ: Gs(Ng)= ( 1.130 - 1.050) x 65,2 = 5.216 triệu đồng

Hiệu suất sử dụng TSCĐ: Gs(Hs)= 1.130 x ( 68,4 - 65,2 ) = + 3.616 triệu đồng

_Bước 4:Tổng hợp các nhân tố ảnh hưởng:5.216 + 3.616 = 8.832 triệu đồng