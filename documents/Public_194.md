...
_id là một trường bắt buộc trong mọi document của MongoDB.id được sử dụng để đại diện cho tính duy nhất của một document trong một collection.

Trườngid hoạt động giống như khóa chính (primary key) của document.

_id là một số thập lục phân 12 byte đảm bảo tính duy nhất của mọi document.

Bạn có thể cung cấpid trong khi chèn document. Trong 12 byte này:
