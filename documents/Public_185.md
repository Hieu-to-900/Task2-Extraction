...
|<image_2>|Giao diện scrum board trong Jira_
...
|<image_3>|Hộp thoại tạo mới một issue trên Jira_
...
|<image_6>|Ví dụ về tìm kiếm nâng cao trên Jira
  ...
  * Tuỳ chỉnh giao diện hiển thị:List view/Detail view_

  * Thay đổi thứ tự sắp xếp trên từng cột: Click vào tên cột

  * Ẩn / Hiện cột: ClickColumnsvà chọn các cột cần ẩn / hiện
...
|<image_7>|Jira cung cấp hơn chục loại báo cáo đa dạng và hữu ích_