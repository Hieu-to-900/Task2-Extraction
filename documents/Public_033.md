...
Mãi đến thế kỉ 13, Pierre de Maricourt (Petrus Peregrinus) thực hiện các thí nghiệm với đá nam châm hình cầu và các vật liệu khác, rồi công bố kết quả trong cuốn“Epistola de Magnete”_. Ông là một trong những người đầu tiên đề xuất khai thác tính chất từ tính để chế tạo các cỗ máy.
...
$$
RT = R0(1 + \alpha\Delta T)R_{T} = \ R_{0}(1\  + \ \alpha\Delta T)
$$
...
$$
R50 = 10(1 + 0.00393 \cdot 30) \approx 11.18\Omega R_{\left\{ 50 \right\}} = \ 10\ (1\  + \ 0.00393\  \cdot 30) \approx 11.18\ \Omega
$$
...
$$
RT = R1 + R2 + R3 + \ldots R_{T} = \ R_{1} + \ R_{2} + \ R_{3} + \ \ldots
$$
...
$$
P = I2R = V2R = V \cdot IP\  = \ I^{2}R\  = \ V^{2}/R = \ V\  \cdot I\
$$
