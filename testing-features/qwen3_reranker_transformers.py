...
class Qwen3Reranker:
    ...
    def process_inputs(self, pairs):
        processed_pairs = []
        for formatted_text in pairs:
            full_text = self.prefix + formatted_text + self.suffix
...
if __name__ == '__main__':
    ...
    queries = ['What is the capital of China?', "Nước nóng để làm gì?", 'Explain gravity']
    documents = [
        "The capital of China is Beijing.",
        "Suối nước nóng là một loại nguồn nước nóng tự nhiên, thường được tìm thấy trong các khu vực núi cao hoặc vùng đất có nhiệt độ cao. Nó thường được sử dụng để tắm, thưởng ngoại, và để chế biến thực phẩm.",
